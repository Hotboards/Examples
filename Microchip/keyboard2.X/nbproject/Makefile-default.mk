...
SOURCEFILES_QUOTED_IF_SPACED=main.c ../../../CodeBank8/middleware/keyboard/keyboard.c ../../../CodeBank8/bsp/Microchip/gpios/gpios.c ../../../CodeBank8/bsp/Microchip/swtimers/swtimers.c ../../../CodeBank8/bsp/Microchip/system/system.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/_ext/970508981/keyboard.o ${OBJECTDIR}/_ext/9437126/gpios.o ${OBJECTDIR}/_ext/660673360/swtimers.o ${OBJECTDIR}/_ext/644714797/system.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.o.d ${OBJECTDIR}/_ext/970508981/keyboard.o.d ${OBJECTDIR}/_ext/9437126/gpios.o.d ${OBJECTDIR}/_ext/660673360/swtimers.o.d ${OBJECTDIR}/_ext/644714797/system.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/_ext/970508981/keyboard.o ${OBJECTDIR}/_ext/9437126/gpios.o ${OBJECTDIR}/_ext/660673360/swtimers.o ${OBJECTDIR}/_ext/644714797/system.o

# Source Files
SOURCEFILES=main.c ../../../CodeBank8/middleware/keyboard/keyboard.c ../../../CodeBank8/bsp/Microchip/gpios/gpios.c ../../../CodeBank8/bsp/Microchip/swtimers/swtimers.c ../../../CodeBank8/bsp/Microchip/system/system.c
...
${OBJECTDIR}/_ext/970508981/keyboard.o: ../../../CodeBank8/middleware/keyboard/keyboard.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/970508981 
	@${RM} ${OBJECTDIR}/_ext/970508981/keyboard.o.d 
	@${RM} ${OBJECTDIR}/_ext/970508981/keyboard.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG  -p$(MP_PROCESSOR_OPTION) -I"." -I"../../../CodeBank8" -I"../../../CodeBank8/bsp/Microchip" -I"../../../CodeBank8/middleware" -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/970508981/keyboard.o   ../../../CodeBank8/middleware/keyboard/keyboard.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/970508981/keyboard.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/970508981/keyboard.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/970508981/keyboard.o: ../../../CodeBank8/middleware/keyboard/keyboard.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/970508981/keyboard.o.d 
	@${RM} ${OBJECTDIR}/_ext/970508981/keyboard.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I"." -I"../../../CodeBank8" -I"../../../CodeBank8/bsp/Microchip" -I"../../../CodeBank8/middleware" -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/970508981/keyboard.o   ../../../CodeBank8/middleware/keyboard/keyboard.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/970508981/keyboard.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/970508981/keyboard.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/keyboard2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    rm18f45j50_g.lkr
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE) "rm18f45j50_g.lkr"  -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/keyboard2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
dist/${CND_CONF}/${IMAGE_TYPE}/keyboard2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   rm18f45j50_g.lkr
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE) "rm18f45j50_g.lkr"  -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/keyboard2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
